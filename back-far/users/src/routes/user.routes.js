...
const { getUsers, getUserById, updateUser, deleteUser, getUsersByRole, getUserNameById, getUserWithEquipos, getTecnicos, contarUsuarios } = require('../controllers/user.controller');
